...
from NASCAR.pybasicbayes.pybasicbayes.abstractions import \
    GibbsSampling, MeanField, MeanFieldSVI, MaxLikelihood, MAP

from NASCAR.pybasicbayes.pybasicbayes.util.stats import sample_discrete

try:
    from NASCAR.pybasicbayes.pybasicbayes.util.cstats import sample_crp_tablecounts
except ImportError:
    warn('using slow sample_crp_tablecounts')
    from NASCAR.pybasicbayes.pybasicbayes.util.stats import sample_crp_tablecounts
