...
from NASCAR.pyhsmm.util.stats import sample_discrete
try:
    from NASCAR.pyhsmm.util.cstats import sample_markov, count_transitions
except ImportError:
    from NASCAR.pyhsmm.util.stats import sample_markov, count_transitions
from NASCAR.pyhsmm.util.general import rle
