...
from NASCAR.pyhsmm.basic.distributions import GammaCompoundDirichlet, Multinomial, \
    MultinomialAndConcentration
from NASCAR.pyhsmm.util.general import rle, cumsum, rcumsum
try:
    from NASCAR.pyhsmm.util.cstats import sample_crp_tablecounts, count_transitions
except ImportError:
    from warnings import warn
    warn('using slow transition counting')
    from NASCAR.pyhsmm.util.stats import sample_crp_tablecounts, count_transitions
