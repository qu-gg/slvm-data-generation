...
from NASCAR.pyhsmm.internals.hmm_states import HMMStatesPython, HMMStatesEigen
from NASCAR.pyhsmm.internals.hsmm_states import HSMMStatesPython, HSMMStatesEigen, \
    GeoHSMMStates

# from pylds.lds_messages_interface import info_E_step, info_sample

from NASCAR.pyslds.util import hmm_entropy, lds_entropy, expected_regression_log_prob, expected_gaussian_logprob
...
class _SLDSStatesCountData(_SLDSStatesMaskedData, _SLDSStatesGibbs):
    def __init__(self, model, data=None, mask=None, **kwargs):
        ...
        import NASCAR.pypolyagamma as ppg
        from NASCAR.pypolyagamma.distributions import _PGLogisticRegressionBase
    ...
    def diagonal_noise(self):
        from NASCAR.pypolyagamma.distributions import _PGLogisticRegressionBase
        from NASCAR.pybasicbayes.pybasicbayes.distributions import DiagonalRegression
