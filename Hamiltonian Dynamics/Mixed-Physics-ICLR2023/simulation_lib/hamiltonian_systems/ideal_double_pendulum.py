...
from simulation_lib.hamiltonian_systems import hamiltonian
from simulation_lib.hamiltonian_systems import phase_space
...
class IdealDoublePendulum(hamiltonian.TimeIndependentHamiltonianSystem):
  ...
  def render_trajectories(
    ...
    print(f"=> Radius1 {radius_1} Radius2 {radius_2}")
